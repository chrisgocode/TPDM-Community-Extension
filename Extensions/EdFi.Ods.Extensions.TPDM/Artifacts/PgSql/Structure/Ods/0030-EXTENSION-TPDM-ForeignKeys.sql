...
ALTER TABLE tpdm.CandidateEducatorPreparationProgramAssociation ADD CONSTRAINT FK_fc61b2_Application FOREIGN KEY (ApplicantProfileIdentifier, ApplicationIdentifier, EducationOrganizationId)
REFERENCES tpdm.Application (ApplicantProfileIdentifier, ApplicationIdentifier, EducationOrganizationId)
;

CREATE INDEX FK_fc61b2_Application
ON tpdm.CandidateEducatorPreparationProgramAssociation (ApplicantProfileIdentifier ASC, ApplicationIdentifier ASC, EducationOrganizationId ASC);
...
CREATE INDEX FK_0d7c2b_CandidateEducatorPreparationProgramAssociation
ON tpdm.CandidateEducatorPreparationProgramAssociationCandidateI_0d7c2b (BeginDate ASC, CandidateIdentifier ASC, EducationOrganizationId ASC, ProgramName ASC, ProgramTypeDescriptorId ASC);

ALTER TABLE tpdm.CandidateEducatorPreparationProgramAssociationCandidateI_fc4f14 ADD CONSTRAINT FK_fc4f14_CandidateEducatorPreparationProgramAssociationCandidateI_0d7c2b FOREIGN KEY (BeginDate, CandidateIdentifier, EducationOrganizationId, IndicatorName, ProgramName, ProgramTypeDescriptorId)
REFERENCES tpdm.CandidateEducatorPreparationProgramAssociationCandidateI_0d7c2b (BeginDate, CandidateIdentifier, EducationOrganizationId, IndicatorName, ProgramName, ProgramTypeDescriptorId)
ON DELETE CASCADE
;
...
CREATE INDEX FK_620d03_CandidateEducatorPreparationProgramAssociation
...
CREATE INDEX FK_2501c4_CandidateEducatorPreparationProgramAssociation
ON tpdm.CandidateEducatorPreparationProgramAssociationDegreeSpec_2501c4 (BeginDate ASC, CandidateIdentifier ASC, EducationOrganizationId ASC, ProgramName ASC, ProgramTypeDescriptorId ASC);
...
ALTER TABLE tpdm.CandidateIndicatorPeriod ADD CONSTRAINT FK_9fac2f_CandidateIndicator FOREIGN KEY (BeginDate, CandidateIdentifier, IndicatorName)
REFERENCES tpdm.CandidateIndicator (BeginDate, CandidateIdentifier, IndicatorName)
ON DELETE CASCADE
;
...
ALTER TABLE tpdm.Goal ADD CONSTRAINT FK_cdbf69_EvaluationObjective FOREIGN KEY (EducationOrganizationId, EvaluationObjectiveTitle, EvaluationPeriodDescriptorId, EvaluationTitle, PerformanceEvaluationTitle, PerformanceEvaluationTypeDescriptorId, SchoolYear, TermDescriptorId)
REFERENCES tpdm.EvaluationObjective (EducationOrganizationId, EvaluationObjectiveTitle, EvaluationPeriodDescriptorId, EvaluationTitle, PerformanceEvaluationTitle, PerformanceEvaluationTypeDescriptorId, SchoolYear, TermDescriptorId)
;

CREATE INDEX FK_cdbf69_EvaluationObjective
ON tpdm.Goal (EducationOrganizationId ASC, EvaluationObjectiveTitle ASC, EvaluationPeriodDescriptorId ASC, EvaluationTitle ASC, PerformanceEvaluationTitle ASC, PerformanceEvaluationTypeDescriptorId ASC, SchoolYear ASC, TermDescriptorId ASC);

ALTER TABLE tpdm.Goal ADD CONSTRAINT FK_cdbf69_Goal FOREIGN KEY (ParentAssignmentDate, ParentGoalTitle, ParentPersonId, ParentSourceSystemDescriptorId)
REFERENCES tpdm.Goal (AssignmentDate, GoalTitle, PersonId, SourceSystemDescriptorId)
;

CREATE INDEX FK_cdbf69_Goal
ON tpdm.Goal (ParentAssignmentDate ASC, ParentGoalTitle ASC, ParentPersonId ASC, ParentSourceSystemDescriptorId ASC);
