...
CREATE TABLE tpdm.CandidateEducatorPreparationProgramAssociation (
    ...
    MajorSpecialization VARCHAR(255) NULL,
    MinorSpecialization VARCHAR(255) NULL,
    ApplicationIdentifier VARCHAR(20) NULL,
    ApplicantProfileIdentifier VARCHAR(32) NULL,
    Discriminator VARCHAR(128) NULL,
...
CREATE TABLE tpdm.CandidateEducatorPreparationProgramAssociationCandidateI_0d7c2b (
    ...
    DesignatedBy VARCHAR(60) NULL,
    CreateDate TIMESTAMP NOT NULL,
    CONSTRAINT CandidateEducatorPreparationProgramAssociationCand_0d7c2b_PK PRIMARY KEY (BeginDate, CandidateIdentifier, EducationOrganizationId, IndicatorName, ProgramName, ProgramTypeDescriptorId)
); 
...
CREATE TABLE tpdm.CandidateEducatorPreparationProgramAssociationCandidateI_fc4f14 (
    ...
    EndDate DATE NULL,
    CreateDate TIMESTAMP NOT NULL,
    CONSTRAINT CandidateEducatorPreparationProgramAssociationCand_fc4f14_PK PRIMARY KEY (BeginDate, CandidateIdentifier, EducationOrganizationId, IndicatorName, ProgramName, ProgramTypeDescriptorId)
); 
...
CREATE TABLE tpdm.CandidateIndicator (
    ...
    DesignatedBy VARCHAR(60) NULL,
    CreateDate TIMESTAMP NOT NULL,
    CONSTRAINT CandidateIndicator_PK PRIMARY KEY (BeginDate, CandidateIdentifier, IndicatorName)
); 
...
CREATE TABLE tpdm.EvaluationElementRating (
    ...
    AreaOfRefinement VARCHAR(4096) NULL,
    AreaOfReinforcement VARCHAR(4096) NULL,
