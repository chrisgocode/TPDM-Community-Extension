...
ALTER TABLE [tpdm].[CandidateEducatorPreparationProgramAssociation] WITH CHECK ADD CONSTRAINT [FK_CandidateEducatorPreparationProgramAssociation_Application] FOREIGN KEY ([ApplicantProfileIdentifier], [ApplicationIdentifier], [EducationOrganizationId])
REFERENCES [tpdm].[Application] ([ApplicantProfileIdentifier], [ApplicationIdentifier], [EducationOrganizationId])
GO
...
CREATE NONCLUSTERED INDEX [FK_CandidateEducatorPreparationProgramAssociationCandidateIndicator_CandidateEducatorPreparationProgramAssociation]
ON [tpdm].[CandidateEducatorPreparationProgramAssociationCandidateIndicator] ([BeginDate] ASC, [CandidateIdentifier] ASC, [EducationOrganizationId] ASC, [ProgramName] ASC, [ProgramTypeDescriptorId] ASC)
GO

ALTER TABLE [tpdm].[CandidateEducatorPreparationProgramAssociationCandidateIndicatorPeriod] WITH CHECK ADD CONSTRAINT [FK_CandidateEducatorPreparationProgramAssociationCandidateIndicatorPeriod_CandidateEducatorPreparationProgramAssociationCandidat] FOREIGN KEY ([BeginDate], [CandidateIdentifier], [EducationOrganizationId], [IndicatorName], [ProgramName], [ProgramTypeDescriptorId])
REFERENCES [tpdm].[CandidateEducatorPreparationProgramAssociationCandidateIndicator] ([BeginDate], [CandidateIdentifier], [EducationOrganizationId], [IndicatorName], [ProgramName], [ProgramTypeDescriptorId])
ON DELETE CASCADE
GO
...
ALTER TABLE [tpdm].[CandidateIndicatorPeriod] WITH CHECK ADD CONSTRAINT [FK_CandidateIndicatorPeriod_CandidateIndicator] FOREIGN KEY ([BeginDate], [CandidateIdentifier], [IndicatorName])
...
ALTER TABLE [tpdm].[Goal] WITH CHECK ADD CONSTRAINT [FK_Goal_EvaluationObjective] FOREIGN KEY ([EducationOrganizationId], [EvaluationObjectiveTitle], [EvaluationPeriodDescriptorId], [EvaluationTitle], [PerformanceEvaluationTitle], [PerformanceEvaluationTypeDescriptorId], [SchoolYear], [TermDescriptorId])
REFERENCES [tpdm].[EvaluationObjective] ([EducationOrganizationId], [EvaluationObjectiveTitle], [EvaluationPeriodDescriptorId], [EvaluationTitle], [PerformanceEvaluationTitle], [PerformanceEvaluationTypeDescriptorId], [SchoolYear], [TermDescriptorId])
GO
...
ALTER TABLE [tpdm].[Goal] WITH CHECK ADD CONSTRAINT [FK_Goal_Goal] FOREIGN KEY ([ParentAssignmentDate], [ParentGoalTitle], [ParentPersonId], [ParentSourceSystemDescriptorId])
